...
- fomarto __bold__ o __strong__ de la se-gunda forma.
...
```
# Tablas
| Personas| Apellido | Documento|
|---------|----------|----------|
|Maxi | Vargas| 12123123|
|Andres| Carrera| 

# Citas
Esto es un ejemplo de un texto referente para crear una cita debajo 
> Esto es una Cita.
...
Esto es un texto dividido por una linea Divisora
...
***
Otro ejemplo de como hacer una linea divisioria

___

es otro ejemplo de crear linea divisora
